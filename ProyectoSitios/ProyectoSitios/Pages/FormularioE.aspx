...
<body>
    <form id="form1" runat="server">
        ...
        <br>
        <br>
        <h1 style="text-align: center; color: #ee8133; font-size: 50px; font-weight: bold;">Formulario de Solicitud de Corporativos </h1>

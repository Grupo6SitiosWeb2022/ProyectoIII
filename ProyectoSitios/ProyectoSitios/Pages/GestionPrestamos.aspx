<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestionPrestamos.aspx.cs" Inherits="ProyectoSitios.Pages.GestionPrestamos" %>
...
<body style="width: 100%; margin-left: auto; margin-right: auto;">
    <form id="form1" runat="server">
        ...
        <div style="margin-left: auto; margin-right: auto;">
            <h1 style="text-align: center; color: #061738; font-size: 50px; font-weight: bold;">Gestión de préstamos</h1>
            <br />
            <br />
            <div class="HeaderTable" style="font-size: xx-large;">
                    ...
                    <asp:TextBox runat="server" style="width:15%;height:auto;" class="input is-rounded" type="text" placeholder="Código préstamo" id="txtcodi"/>
                     <p style="display: inline; color: #ee8133; text-align: center;">
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="RolesButton"  Font-Size="X-Large" OnClick="btnEliminar_Click"  />
                    </p>
                <p style="display: inline; color: #ee8133; text-align: center;">
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="RolesButton"  Font-Size="X-Large" OnClick="btnModificar_Click"  />
                    </p>
                    ...
                    <div class="Grafico">
                        ...
                        <div class="grafico1" style="border-radius: 0%; height:100%">
                            ...
                            <div style="width: 90%; height:auto; text-align: center; align-items: center; margin-left: auto; margin-right: auto;">
                                    ...
                                    <asp:Table ID="tablapres" runat="server" style="height:auto" CssClass="table is-striped" ForeColor="#0B0550" HorizontalAlign="Center" Width="100%" Height="90%" Font-Size="X-Large">

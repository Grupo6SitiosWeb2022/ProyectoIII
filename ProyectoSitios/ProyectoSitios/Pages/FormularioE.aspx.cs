...
namespace ProyectoSitios.Pages
{
    public partial class FormularioE : System.Web.UI.Page
    {
        ...
        {
            numformularioE = Session["NumpE"].ToString();
            var result = false;
            ...
            if (IsReCaptchValid() && CHD.Checked)
            {
                try
                {
                    ...
                    PrestamoSolcitudCreditoClass scp = new PrestamoSolcitudCreditoClass()
                    {
                        ...
                        CodigoPrestamo = Convert.ToInt32(numformularioE),
                        //TO DO Cargar desde la API TASA
                        Tasainteresactual = cargarprestamos(Convert.ToInt32(numformularioE)),
                        //TO DO Cargar desde la API TASA

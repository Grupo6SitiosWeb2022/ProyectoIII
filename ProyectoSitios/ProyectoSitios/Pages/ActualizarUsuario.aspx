<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarUsuario.aspx.cs" Inherits="ProyectoSitios.Pages.ActualizarUsuario" %>
    ...
    <form id="form1" runat="server">
      ...
      <div class="card-content" style="text-align:center">
              <div>
                  ...
                  <h1 style="font-size:35px; color:#ee8133; font-weight:bold">Actualizar datos de usuario</h1>
                  ...
                  <div class="col-sm-3">
                        <div class="g-recaptcha" style="text-align:center" data-sitekey="6Lfg9HkfAAAAAIW_ZYXaYq4NrFxHS1HieA039D5W"></div>
                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistasInformacionT.aspx.cs" Inherits="ProyectoSitios.Pages.VistasInformacionT" %>
        ...
        <div>
            <nav class="navbar" style="z-index: 100; top: 35px; background-color: #061738; color: white" role="navigation" aria-label="dropdown navigation">
              <div class="navbar-menu" style="color: #ee8133;">
                    ...
                    <div class="navbar-end">
                        <a class="navbar-link" style="color: #ee8133;" href="../Pages/GraficosT.aspx">Gráficos
                        </a>
                    </div>

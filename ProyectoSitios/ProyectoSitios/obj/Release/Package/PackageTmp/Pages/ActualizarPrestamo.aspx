<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarPrestamo.aspx.cs" Inherits="ProyectoSitios.Pages.ActualizarPrestamo" %>
    ...
    <form id="form1" runat="server">
      ...
      <div class="card-content" style="text-align:center">
              <div>
                  ...
                  <h1 style="font-size:35px; color:#ee8133; font-weight:bold">Actualización de préstamos</h1>
                  ...
                  <p class="p1" style="display:inline"> <img style="width:40px;height:auto;display:inline" src="../img/g1.png"/> 
                      <asp:TextBox runat="server" style="width:70%;height:auto;" class="input is-rounded" type="text" placeholder="Código del préstamo" id="txtcodi" OnTextChanged="txtcodi_TextChanged"/> </p>
                  ...
                  <asp:Button class="button is-info is-outlined" style="width: 30%; height:auto" ID="btnActualizar" runat="server" Text="Actualizar" OnClick="btnActualizar_Click"   />

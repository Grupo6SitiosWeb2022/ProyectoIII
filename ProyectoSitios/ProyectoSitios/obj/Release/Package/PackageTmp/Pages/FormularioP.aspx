<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormularioP.aspx.cs" Inherits="ProyectoSitios.Pages.FormularioP" %>
...
<body>
 ...
 <div class="navbar-end">
        ...
        <br />
       <br><br><br>
       <h1 style="text-align: center; color: #ee8133; font-size: 50px; font-weight: bold;">Formulario de Solicitud de PYMES </h1>   
                    ...
                    <div style="margin-left: 40px; display: flex;">
                        <div style="padding: 10px; float: left; width: 45%; text-align: justify;">
                            ...
                            <asp:DropDownList ID="ddlTiposIdentificacion" runat="server" CssClass="select.is-info select">
                                ...
                                <asp:ListItem Value="5">Juridica</asp:ListItem>
                            </asp:DropDownList>
                            <br />
                            <br />
...
<asp:RadioButton ID="CHD" runat="server" />
Acepto que el Conglomerado Financiero Banco NAV hará uso responsable de mis datos personales conforme a
la ley N° 8968 de Protección a la persona frente al tratamiento de sus datos personales.
</label>
<br />
                        ...
                        <div style="padding: 10px; float: right; width: 45%; text-align: justify;">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lblPlazo" runat="server" Text="">Plazo(Meses)</asp:Label>
                            <br />
                            <asp:TextBox ID="txtPlazo" runat="server"></asp:TextBox>
                            <br />
                            <br />
                            <asp:Label ID="lblSalario" runat="server" Text="">Ingresos netos</asp:Label>
                            <br />
                    ...
                    <div style="padding-left:170px">
                        <div class="g-recaptcha" data-sitekey="6LeZIn0fAAAAAOmgZlh5Kn4hQ_NFCGfq9FY8UdgZ"></div>
                    </div>
       ...
       <div>
                        ...
                        <div class="itemCarrusel" id="ItemC-1">
                            <div class="tarjetasC" id="tarjetasC-1">
                                <div>
                                    <div class="tarjeta">
                                        <img src="../img/PPYMES.png" />
                                        <div class="descripcion">
                                            <br />
                                            <h1>Prestamo Pymes</h1>
                                            <br />
                                            <p>
                                               ¿Tiene algún proyecto en mente?
Le ofrecemos financiamiento para hacerlo realidad </p>

                                            <div class="TarjetaBTN">
                                                <button class="button is-info is-outlined" style="width: 130px; height: 30px;">
                                                    <a class="enlace" href="../Pages/FormularioP.aspx">Solicitar</a>
                                                </button>
                                                <button class="button is-info is-outlined" style="width: 110px; height: 30px;">
                                                    <span class="icon is-small">
                                                        ...
                                                        <a class="enlace" href="../Pages/PrestamosPymes.aspx">Ver más</a>
                                                    </span>
                                                </button>
                                            </div>
                                        </div>
